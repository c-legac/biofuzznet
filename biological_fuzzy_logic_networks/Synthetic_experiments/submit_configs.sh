...
for file in $config_folder*.json
    do 
        # echo ${file}
        jbsub -q x86_6h -cores 1+1 -mem 100g python /u/adr/Code/biological_fuzzy_logic_networks/biological_fuzzy_logic_networks/Synthetic_experiments/perturbation.py $file
    done