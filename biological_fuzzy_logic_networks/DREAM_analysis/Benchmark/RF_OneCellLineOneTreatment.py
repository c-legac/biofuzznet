...
np.save(
    "/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLineOneTreatment/RF_OneCellLine_train.npy",
    train,
)

np.save(
    "/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLineOneTreatment/RF_OneCellLine_test.npy",
    test,
)
...
for marker_to_predict in markers_to_predict:
    ...
    np.save(
        f"/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLineOneTreatment/{marker_to_predict}.npy",
        pred,
    )
