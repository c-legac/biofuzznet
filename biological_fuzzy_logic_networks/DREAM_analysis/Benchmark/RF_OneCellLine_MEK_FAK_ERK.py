...
np.save(
    "/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLine_MEK_FAK_ERK_MF_inputs/RF_OneCellLine_train.npy",
    train,
)

np.save(
    "/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLine_MEK_FAK_ERK_MF_inputs/RF_OneCellLine_test.npy",
    test,
)
...
for marker_to_predict in markers_to_predict:
    ...
    np.save(
        f"/dccstor/ipc1/CAR/DREAM/Model/Baseline/RF_OneCellLine_MEK_FAK_ERK_MF_inputs/{marker_to_predict}.npy",
        pred,
    )
