...
def create_and_save_configs(sampled_params, base_config):
    ...
    config[
        "output_dir"
    ] = f"{base_config['output_dir']}{sampled_params['cell_line']}_{sampled_params['test_treatments']}_"

    config[
        "data_file"
    ] = f"/dccstor/ipc1/CAR/DREAM/DREAMdata/{sampled_params['cell_line']}.csv"
...
if __name__ == "__main__":
    ...
    param_grid = {
        ...
        # "train_treatments": [],
        "test_treatments": ["iEGFR", "iMEK", "iPI3K", "iPKC"],
        # "learning_rate": [],
        # "n_epochs": [],
        # "batch_size": [],
    }
